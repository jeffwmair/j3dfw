...
class Shader {
    ...
    static void initShaders(GL2 gl, String vertexShaderResource, String fragmentShaderResource) {
        ...
        InputStream vertexShaderInStream = Shader.class.getClassLoader()
                .getResourceAsStream("graphics/" + vertexShaderResource);
        ...
        InputStream fragmentShaderInStream = Shader.class.getClassLoader()
                .getResourceAsStream("graphics/" + fragmentShaderResource);
