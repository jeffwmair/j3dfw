...
public class TargetCamera extends Camera {
    ...
    protected void look(GLU glu) {
        ...
        log.trace("camera_position: {}, camera_target: {}, verticalDistance: {}", camera_position, camera_target,
                verticalDistance);
        glu.gluLookAt(camera_position.getX(), camera_position.getY() + verticalDistance, camera_position.getZ(),
                camera_target.getX(), camera_target.getY(), camera_target.getZ(), 0, 1, 0);
    }
